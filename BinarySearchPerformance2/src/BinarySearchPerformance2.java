...
public class BinarySearchPerformance2 {
    ...
    static int MAXINPUTSIZE  = (int) Math.pow(2,29);
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("BinSearch-Exp1-ThrowAway.txt");

        runFullExperiment("BinSearch-Exp2.txt");

        runFullExperiment("BinSearch-Exp3.txt");
